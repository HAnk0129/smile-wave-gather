DROP FUNCTION IF EXISTS public.create_campus_invite(uuid, integer, integer);
...
REVOKE EXECUTE ON FUNCTION public.create_campus_invite(uuid, integer, integer, boolean) FROM anon;
GRANT EXECUTE ON FUNCTION public.create_campus_invite(uuid, integer, integer, boolean) TO authenticated;
GRANT EXECUTE ON FUNCTION public.create_campus_invite(uuid, integer, integer, boolean) TO service_role;