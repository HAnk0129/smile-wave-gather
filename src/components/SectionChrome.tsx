...
export function Header({ title, subtitle, icon }: { title: string; subtitle?: string; icon?: ReactNode }) {
  return (
    <header
      ...
      style={{
        backgroundImage:
          "radial-gradient(circle at top left, rgba(255,138,0,0.8) 0%, rgba(255,138,0,0.8) 40%, rgba(255,138,0,0) 70%), radial-gradient(circle at top right, rgba(255,138,0,0.8) 0%, rgba(255,138,0,0.8) 40%, rgba(255,138,0,0) 70%), linear-gradient(#FFFFFF, #FFFFFF)",
